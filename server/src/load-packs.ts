  ...
  for (const datapack of datapacks) {
    ...
    await parseDatapacks(datapack, decryptionDirectory, userUploaded)
      .then((datapackParsingPack) => {
        ...
        console.log(`Successfully parsed ${datapack.file}`);
      })
      .catch((e) => {
        console.log(`Cannot create a datapackParsingPack with datapack ${datapack.file} and error: ${e}`);
      });
    await parseMapPacks([datapack.file], decryptionDirectory)
      ...
      .catch((e) => {
        console.log(`Cannot create a mapPack with datapack ${datapack.file} and error: ${e}`);
      });
  }
  await grabMapImages(
